tap "anomalyco/tap"
tap "kappke/tap", "https://github.com/kappke/homebrew-tap.git"
tap "nikitabobko/tap"
...
# TUI client for ClickUp (untrusted tap: run `brew trust kappke/tap` first)
brew "kappke/tap/lazy-click", trusted: true
cask "aerospace"
...
vscode "easy-pattern.easy-pattern"
